...
namespace ModeloRegistro.reports.entidades
{
    class Anexo2
    {
        ...
        public string dia_fecha_de_solicitud { get; set; }
        public string mes_fecha_de_solicitud { get; set; }
        public string anno_fecha_de_solicitud { get; set; }
        ...
        public string color_ojos_claros { get; set; }
        public string color_ojos_negros { get; set; }
        public string color_ojos_pardos { get; set; }
        public string color_piel_blanca { get; set; }
        public string color_piel_negra { get; set; }
        public string color_piel_amarilla { get; set; }
        public string color_piel_mestiza { get; set; }
        public string color_piel_albina { get; set; }
        ...
        public string dia_fecha_de_salida { get; set; }
        public string mes_fecha_de_salida { get; set; }
        public string anno_fecha_de_salida { get; set; }
        public string pais { get; set; }
        public string provincia { get; set; }
        public string municipio_ciudad { get; set; }
        public string dia_fecha_de_nacimiento { get; set; }
        public string mes_fecha_de_nacimiento { get; set; }
        public string anno_fecha_de_nacimiento { get; set; }
