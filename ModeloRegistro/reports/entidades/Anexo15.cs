...
namespace ModeloRegistro.reports.entidades
{
    ...
    public string dia_fecha_fallecimineto { get; set; }
    public string mes_fecha_fallecimineto { get; set; }
    public string anno_fecha_fallecimineto { get; set; }
    ...
    public string dia_fecha_defuncion { get; set; }
    public string mes_fecha_defuncion { get; set; }
    public string anno_fecha_defuncion { get; set; }
    ...
    public string dia_fecha_certificado { get; set; }
    public string mes_fecha_certificado { get; set; }
    public string anno_fecha_certificado { get; set; }
