...
namespace ModeloRegistro.reports.entidades
{
    ...
    public string dia_fecha_nacimineto_contrayente { get; set; }
    public string mes_fecha_nacimineto_contrayente { get; set; }
    public string anno_fecha_nacimineto_contrayente { get; set; }
