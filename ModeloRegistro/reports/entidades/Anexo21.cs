...
namespace ModeloRegistro.reports.entidades
{
    class Anexo21
    {
        ...
        public string dia_fecha_nacimiento_padre { get; set; }
        public string mes_fecha_nacimiento_padre { get; set; }
        public string anno_fecha_nacimiento_padre { get; set; }
        ...
        public string dia_fecha_nacimiento_menor { get; set; }
        public string mes_fecha_nacimiento_menor { get; set; }
        public string anno_fecha_nacimiento_menor { get; set; }
