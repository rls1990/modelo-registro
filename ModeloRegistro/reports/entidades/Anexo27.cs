...
namespace ModeloRegistro.reports.entidades
{
    class Anexo27
    {
        ...
        public string nombre_donatorio { get; set; }
        public string sexo_donatorio { get; set; }
        public string lugar_nacimiento_municipio_donatorio { get; set; }
        public string lugar_nacimiento_provincia_donatorio { get; set; }
        public string dia_fecha_nacimineto_donatorio { get; set; }
        public string mes_fecha_nacimineto_donatorio { get; set; }
        public string anno_fecha_nacimineto_donatorio { get; set; }
        public string estado_civil_donatorio { get; set; }
        public string ciudadania_donatorio { get; set; }
        public string ocupacion_donatorio { get; set; }
        public string direccion_particular_donatorio { get; set; }
