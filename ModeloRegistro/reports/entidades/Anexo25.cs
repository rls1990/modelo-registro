...
namespace ModeloRegistro.reports.entidades
{
    class Anexo25
    {
        ...
        public string dia_fecha_nacimineto_poderante { get; set; }
        public string mes_fecha_nacimineto_poderante { get; set; }
        public string anno_fecha_nacimineto_poderante { get; set; }
        ...
        public string dia_fecha_nacimineto_apoderado { get; set; }
        public string mes_fecha_nacimineto_apoderado { get; set; }
        public string anno_fecha_nacimineto_apoderado { get; set; }
        ...
        public string nombre_contrallente { get; set; }
        public string sexo_contrallente { get; set; }
        public string lugar_nacimiento_municipio_contrallente { get; set; }
        public string lugar_nacimiento_provincia_contrallente { get; set; }
        public string dia_fecha_nacimineto_contrallente { get; set; }
        public string mes_fecha_nacimineto_contrallente { get; set; }
        public string anno_fecha_nacimineto_contrallente { get; set; }
        public string estado_civil_contrallente { get; set; }
        public string ciudadania_contrallente { get; set; }
        public string ocupacion_contrallente { get; set; }
        public string direccion_particular_contrallente { get; set; }
        public string carne_pasaporte_contrallente { get; set; }
