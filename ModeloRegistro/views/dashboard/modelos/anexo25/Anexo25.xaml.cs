                ...
                if(res==MessageBoxResult.Yes)
                {
                    ...
                    if(dialog.ShowDialog()==CommonFileDialogResult.Ok)
                    {
                        ...
                        reports.entidades.Anexo25 anexo = new reports.entidades.Anexo25()
                        {
                            ...
                            dia_fecha_nacimineto_contrallente=ValidarCampo(entity.fecha_nacimineto_contrallente) ? entity.fecha_nacimineto_contrallente.Split('-')[2]:"",
                            mes_fecha_nacimineto_contrallente=ValidarCampo(entity.fecha_nacimineto_contrallente) ? entity.fecha_nacimineto_contrallente.Split('-')[1]:"",
                            anno_fecha_nacimineto_contrallente=ValidarCampo(entity.fecha_nacimineto_contrallente) ? entity.fecha_nacimineto_contrallente.Split('-')[0]:"",
