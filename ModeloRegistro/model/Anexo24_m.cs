    ...
    public class Anexo24_m
    {
        ...
        public List<Anexo24_e> list()
        {
            ...
            while (sqlite_datareader.Read())
            {
                ...
                anexo24_e.nombre_padres_apoderado = sqlite_datareader.GetString(24);
                anexo24_e.condicion_migratoria_apoderado = sqlite_datareader.GetString(25);
                anexo24_e.marca = sqlite_datareader.GetString(26);
                anexo24_e.modelo = sqlite_datareader.GetString(27);
                anexo24_e.anno = sqlite_datareader.GetString(28);
                anexo24_e.color = sqlite_datareader.GetString(29);
                anexo24_e.nro_motor = sqlite_datareader.GetString(30);
                anexo24_e.nro_chasis = sqlite_datareader.GetString(31);
                anexo24_e.matricula = sqlite_datareader.GetString(32);
                list.Add(anexo24_e);
            }
