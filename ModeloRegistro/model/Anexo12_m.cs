    ...
    public class Anexo12_m
    {
        ...
        public List<Anexo12_e> list()
        {
            ...
            while (sqlite_datareader.Read())
            {
                ...
                anexo12_e.id = sqlite_datareader.GetInt32(0);
                anexo12_e.ciudad = sqlite_datareader.GetString(1);
                anexo12_e.pais = sqlite_datareader.GetString(2);
                anexo12_e.nombre_apellidos = sqlite_datareader.GetString(3);
